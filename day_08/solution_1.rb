...
def find_antipodes(antenna1, antenna2, width, height)
  ...
  antipode_list = []
  antipode_list << antipode_1 if antipode_1[0] >= 0 && antipode_1[0] < width && antipode_1[1] >= 0 && antipode_1[1] < height
  antipode_list << antipode_2 if antipode_2[0] >= 0 && antipode_2[0] < width && antipode_2[1] >= 0 && antipode_2[1] < height
